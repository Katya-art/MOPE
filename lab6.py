...
func = "2,2 + 1,6*x1 + 9,2*x2 + 9,5*x3 + 0,8*x1*x1 + 0,7*x2*x2 + 6,5*x3*x3 + 0,2*x1*x2 + 0,9*x1*x3 + 8,7*x2*x3 + 9,1*x1*x2*x3"
...
while (flag):
    ...
    for i in range(len(Nt)):
        ...
        y1t.append(round(2.2 + 1.6 * x1[i] + 9.2 * x2[i] + 9.5 * x3[i] + 0.8 * x1sq[i] + 0.7 * x2sq[i] + 6.5 * x3sq[i]
                         + 0.2 * x1x2[i] + 0.9 * x1x3[i] + 8.7 * x2x3[i] + 9.1 * x1x2x3[i] + random.randint(0, 10) - 5,
                         3))
        y2t.append(round(2.2 + 1.6 * x1[i] + 9.2 * x2[i] + 9.5 * x3[i] + 0.8 * x1sq[i] + 0.7 * x2sq[i] + 6.5 * x3sq[i]
                         + 0.2 * x1x2[i] + 0.9 * x1x3[i] + 8.7 * x2x3[i] + 9.1 * x1x2x3[i] + random.randint(0, 10) - 5,
                         3))
        y3t.append(round(2.2 + 1.6 * x1[i] + 9.2 * x2[i] + 9.5 * x3[i] + 0.8 * x1sq[i] + 0.7 * x2sq[i] + 6.5 * x3sq[i]
                         + 0.2 * x1x2[i] + 0.9 * x1x3[i] + 8.7 * x2x3[i] + 9.1 * x1x2x3[i] + random.randint(0, 10) - 5,
                         3))
        y4t.append(round(2.2 + 1.6 * x1[i] + 9.2 * x2[i] + 9.5 * x3[i] + 0.8 * x1sq[i] + 0.7 * x2sq[i] + 6.5 * x3sq[i]
                         + 0.2 * x1x2[i] + 0.9 * x1x3[i] + 8.7 * x2x3[i] + 9.1 * x1x2x3[i] + random.randint(0, 10) - 5,
                         3))
        if m == 3:
